...
//            values.add(newValue);
    ...
    public static <T extends Enum<?>> void addEnum(Class<T> enumType, String enumName, Integer key, String value) {
        Class[] additionalTypes = new Class[]{Integer.class, String.class};
        Object[] additionalValues = new Object[]{key, value};
        addEnum(enumType, enumName, additionalTypes, additionalValues);
