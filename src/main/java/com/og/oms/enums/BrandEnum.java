 ...
 * 品牌枚举
 */
public enum BrandEnum implements IEnum {
;
    /**
     * 标识
     */
    ...
    BrandEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
        this.del = 0;
    }

    BrandEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(BrandEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(BrandEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
