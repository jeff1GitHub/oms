...
public enum AreaEnum implements IEnum {
    ...
    AreaEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(AreaEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(AreaEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
