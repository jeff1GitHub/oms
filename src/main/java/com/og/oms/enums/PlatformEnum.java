...
public enum PlatformEnum implements IEnum {
    ...
    PlatformEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(PlatformEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(PlatformEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(PlatformEnum iEnum : PlatformEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
