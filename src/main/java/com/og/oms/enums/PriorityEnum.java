...
public enum PriorityEnum implements IEnum {
    ...
    PriorityEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(PriorityEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(PriorityEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(PriorityEnum iEnum : PriorityEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
