...
public enum ProjectEnum implements IEnum {
    ...
    ProjectEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
        this.del = 0;
    }

    ProjectEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(ProjectEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(ProjectEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(ProjectEnum iEnum : ProjectEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
    ...
    public static ProjectEnum getProjectEnum(Integer code) {
    	for(ProjectEnum tempEnum : ProjectEnum.values()) {
