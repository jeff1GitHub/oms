...
public enum ServiceTypeEnum implements IEnum {
    ...
    ServiceTypeEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(ServiceTypeEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(ServiceTypeEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(ServiceTypeEnum iEnum : ServiceTypeEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
    ...
    public static ServiceTypeEnum getServiceTypeEnum(int code) {
    	for(ServiceTypeEnum tempEnum : ServiceTypeEnum.values()) {
    		if(tempEnum.getCode() == code) {
    			return tempEnum;
    		}
    	}
    	 return null;
