 ...
 * 产品型号
 */
public enum DevicesNumberEnum implements IEnum {
;
    /**
     * 标识
     */
    ...
    DevicesNumberEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
        this.del = 0;
    }

    DevicesNumberEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(DevicesNumberEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(DevicesNumberEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
