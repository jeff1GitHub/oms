...
public enum GroupEnum implements IEnum {
    ...
    GroupEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(GroupEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(GroupEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(GroupEnum iEnum : GroupEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
    ...
    public static GroupEnum getGroupEnum(Integer code) {
