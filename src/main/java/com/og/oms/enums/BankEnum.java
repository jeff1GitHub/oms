...
public enum BankEnum implements IEnum {
    ...
    BankEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(BankEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(BankEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(BankEnum iEnum : BankEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
