 ...
 * 网设类型枚举
 */
public enum DevicesTypeEnum implements IEnum {
;
    /**
     * 标识
     */
    ...
    DevicesTypeEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
        this.del = 0;
    }

    DevicesTypeEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(DevicesTypeEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(DevicesTypeEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
