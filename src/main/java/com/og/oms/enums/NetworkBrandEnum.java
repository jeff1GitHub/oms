...
public enum NetworkBrandEnum implements IEnum {
    ;
    /**
     * 标识
     */
    ...
    NetworkBrandEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
        this.del = 0;
    }

    NetworkBrandEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(NetworkBrandEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(NetworkBrandEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(NetworkBrandEnum iEnum : NetworkBrandEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
