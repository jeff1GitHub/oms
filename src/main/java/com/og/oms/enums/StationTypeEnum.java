...
public enum StationTypeEnum implements IEnum {
    ;
    ...
    StationTypeEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(StationTypeEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(StationTypeEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(StationTypeEnum iEnum : StationTypeEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
