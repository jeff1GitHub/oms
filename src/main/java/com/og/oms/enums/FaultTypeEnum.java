...
public enum FaultTypeEnum implements IEnum {
    ;
    /**
     * 标识
     */
    ...
    FaultTypeEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
        this.del = 0;
    }

    FaultTypeEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(FaultTypeEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(FaultTypeEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(FaultTypeEnum iEnum : FaultTypeEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
    ...
    public static FaultTypeEnum getFaultTypeEnum(Integer code) {
    	for(FaultTypeEnum tempEnum : FaultTypeEnum.values()) {
