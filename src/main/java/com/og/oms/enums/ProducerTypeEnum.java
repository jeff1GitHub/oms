...
public enum ProducerTypeEnum implements IEnum {
    ;
    /**
     * 标识
     */
    ...
    ProducerTypeEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(ProducerTypeEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(ProducerTypeEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(ProducerTypeEnum iEnum : ProducerTypeEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
    ...
    public static ProducerTypeEnum getProducerTypeEnum(Integer code) {
    	for(ProducerTypeEnum tempEnum : ProducerTypeEnum.values()) {
