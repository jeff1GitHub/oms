...
public enum AliasTypeEnum implements IEnum {
    ALIAS_TYPE_PAY(1, "支付别名"),
    ALIAS_TYPE_NORMAL(2, "别名"),
    ALIAS_TYPE_PAYMENT(3, "新支付别名");
    ...
    AliasTypeEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
        this.del = 0;
    }

    AliasTypeEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(AliasTypeEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(AliasTypeEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(AliasTypeEnum iEnum : AliasTypeEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
