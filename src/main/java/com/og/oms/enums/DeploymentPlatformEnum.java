 ...
 * 平台枚举
 */
public enum DeploymentPlatformEnum implements IEnum {
    ;
    ...
    DeploymentPlatformEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
        this.del = 0;
    }

    DeploymentPlatformEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(DeploymentPlatformEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(DeploymentPlatformEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(DeploymentPlatformEnum iEnum : DeploymentPlatformEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
