 ...
 * 平台枚举
 */
public enum EnvironmentEnum implements IEnum {
    ;
    ...
    EnvironmentEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
        this.del = 0;
    }

    EnvironmentEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(EnvironmentEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(EnvironmentEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(EnvironmentEnum iEnum : EnvironmentEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
