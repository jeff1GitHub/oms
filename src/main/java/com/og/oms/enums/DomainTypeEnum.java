...
public enum DomainTypeEnum implements IEnum {
    DOMAIN_MAIN(1, "主域名"),
    DOMAIN_TEST(2, "测试域名"),
    DOMAIN_CLIENT(3, "客户测试域名"),
    DOMAIN_MANAGE(4, "后台域名"),;
    ;
    ...
    DomainTypeEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
        this.del = 0;
    }

    DomainTypeEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(DomainTypeEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(DomainTypeEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(DomainTypeEnum iEnum : DomainTypeEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
