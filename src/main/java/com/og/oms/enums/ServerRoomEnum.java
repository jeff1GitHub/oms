 ...
 * 机房枚举
 */
public enum ServerRoomEnum implements IEnum {
    ;
    /**
     * 标识
     */
    ...
    ServerRoomEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
        this.del = 0;
    }

    ServerRoomEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static void clearEnum() {
        EnumUtil.clearEnum(ServerRoomEnum.class);
    }
    ...
    public static void addEnum(Integer code, String name, Integer del) {
        ...
        EnumUtil.addEnum(ServerRoomEnum.class, String.valueOf(code), additionalTypes, additionalValues);
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(ServerRoomEnum iEnum : ServerRoomEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
