...
public enum ProducerEnum implements IEnum {
    ...
    ProducerEnum(Integer code, String name, Integer del) {
        this.code = code;
        this.name = name;
        this.del = del;
    }
    ...
    public static List<IEnum> getSelect() {
        ...
        for(ProducerEnum iEnum : ProducerEnum.values()) {
            if(iEnum.getDel() == 0) {
                list.add(iEnum);
            }
        }
    ...
    public static ProducerEnum getProducerEnum(Integer code) {
    	for(ProducerEnum tempEnum : ProducerEnum.values()) {
