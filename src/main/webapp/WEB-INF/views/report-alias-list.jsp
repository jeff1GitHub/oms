...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 别名问题报表
...
<div class="page-container">
    <div class="text-c">
        <form id="form-report-search">
            ...
            <select id="platform" name="platform" style="width:180px; padding-bottom: 5px" class="input-text">
                <option value="">请选择平台</option>
                <c:forEach var="item" items="${platform}"><option value="${item.code }">${item.name }</option></c:forEach>
            </select>
            <input type="text" id="stationCode" name="stationCode" class="input-text" style="width:180px" placeholder="输入站点编号" >
            <input type="text" id="aliasName" name="aliasName" class="input-text" style="width:180px" placeholder="输入别名" >
